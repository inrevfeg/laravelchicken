                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input" style="float: left">' +
                      ...
                      '<input class="input-mini" id="daterangepicker_start" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="float: left; padding-left: 11px">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" id="daterangepicker_end" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
