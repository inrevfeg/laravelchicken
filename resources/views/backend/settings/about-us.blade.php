                            ...
                            <table id="example1" class="table table-bordered">
                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td>
                                            <a href="{{ route('about.edit',$item->id) }}" class="btn btn-info btn-sm btn-flat" title="Edit Data"><i class="fa fa-pencil"></i> </a>
                                            <a href="{{ route('about.delete',$item->id) }}" class="btn btn-danger btn-sm btn-flat" title="Delete Data" id="delete">
