                            ...
                            <table id="dataTableExample" class="table table-bordered">
                                ...
                                <tbody id="tbodyList">
                                    ...
                                    <tr id="emptyRow" style="height: 25px;">
                                        ...
                                        <td>
                                        <label for="">                              
                                                <span class="badge badge-pill badge-warning text-white" style="background: #80000b;"> Cancel </span>
                                        </label>
                                    </td>
                                        ...
                                        {{-- <td>
                                            {{ route('cancel.order.approve',$item->id) }}
                                            <a href="" class="btn btn-info" title="Edit Data"><i class="fa fa-eye"></i> Approve</a>
                                        </td>         --}}
                                    </tr>
                                    @php
                                        $serialNo++;
