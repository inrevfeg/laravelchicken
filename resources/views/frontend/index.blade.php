                    ...
                    <div class="media">
                        <div class="child-elememt">
                            <a href="#" class="link-to">
                                ...
                                {{-- <img src="{{ asset($item->slider_image)}}" width="604" height="580" alt=""> --}}
                            </a>
                        </div>
                    </div>
    ...
    <div class="special-slide">
        <div class="container">
                        ...
                        <div class="banner-contain">
                            <div class="media">
                                <a href="#" class="bn-link">
                                    <figure><img src="{{ asset($item->slider_image)}}" width="616" height="483" alt=""></figure>
                                </a>
                            </div>
                            <div class="text-content">
                                <b class="first-line">Chicken</b>
                                <span class="second-line"> Heaven Made</span>
            ...
            <div class="biolife-service type01 biolife-service__type01 sm-margin-top-0 xs-margin-top-45px">
                <b class="txt-show-01">100%Pure</b>
                <i class="txt-show-02">Fresh Meat</i>
            ...
            <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                    <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                        <li class="tab-element active">
                            <a href="#tab01_1st" class="tab-link"><span class="biolife-icon icon-lemon"></span>All</a>
                        </li>
                        @foreach($categories as $category)
                        <li class="tab-element">
                            <a href="#category{{$category->id}}" class="tab-link"><span class="biolife-icon icon-lemon"></span>{{ $category->categoryName}}</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab01_1st" class="tab-contain active">
                        <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":2 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":25 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":15}}]}'> @foreach($products as $product)
                            <li class="product-item">
                                <div class="contain-product layout-default">
                                    <div class="product-thumb">
                                        <a href="{{url('product/details/'.$product->id.'/'.$product->productSlug ) }}" class="link-to-product">
                                            <img src="{{ asset($product->productImage) }}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                        </a>
                                        <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                    </div>
                                    <div class="info">
                                        <b class="categories">{{$product->category->categoryName}}</b>
                                        <h4 class="product-title"><a href="{{url('product/details/'.$product->id.'/'.$product->productSlug ) }}" class="pr-name"> {{$product->productName}}</a></h4>
                                  @if ($product->productDiscount == 0.00)
                                        ...
                                        @else
                                        <div class="price ">
                                            <ins><span class="price-amount"><span class="currencySymbol">₹</span>{{ $product->productDiscount }}</span></ins>
                                            <del><span class="price-amount"><span class="currencySymbol">₹</span>{{ $product->productPrice }}</span></del>
                                        </div>
                                        @endif
                                        <div class="slide-down-box">
                                            <p class="message">{{$product->productDescription}}.</p>
                                            <div class="buttons">
                                                ...
                                                {{-- <button  class="btn add-to-cart-btn" id="{{ $product->id }}" onclick="addToCartsimple(this.id)">add to cart</button>    --}}
                    ...
                    @foreach($categories as $category)
                    <div id="category{{$category->id}}" class="tab-contain">
                        <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":2 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":25 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":15}}]}'>
                            @php
                            $catwiseProduct = App\Models\Product::with('category')->where('categoryId',$category->id)->orderBy('id','DESC')->get();
                            @endphp
            ...
            <div class="banner-contain">
                ...
                <div class="text-content">
                    <div class="container text-wrap">
                        <i class="first-line">Chicken  100% Pure</i>
                        <span class="second-line">Meat Always fresh</span>
                ...
                <div class="col-lg-4 col-md-5 col-sm-6">
                    <div class="advance-product-box">
                        ...
                        <ul class="products biolife-carousel nav-top-right nav-none-on-mobile" data-slick='{"arrows":true, "dots":false, "infinite":false, "speed":400, "slidesMargin":30, "slidesToShow":1}'>
                            @foreach($is_hotDeals as $product)
                            <li class="product-item">
                                <div class="contain-product deal-layout contain-product__deal-layout">
                                    <div class="product-thumb">
                                        <a href="#" class="link-to-product">
                                            <img src="{{ asset($product->productImage) }}" alt="dd" width="330" height="330" class="product-thumnail">
                                        </a>
                                        <div class="labels">
                                            @php
                                            $amount = $product->productPrice - $product->productDiscount;
                                            $discount = ($amount/$product->productPrice) * 100;
                                            @endphp
                                            <span class="sale-label">{{ round($discount) }}%</span>
                                        </div>
                                    </div>
                                    <div class="info">
            ...
            <ul class="biolife-carousel nav-center-bold nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}},{"breakpoint":450, "settings":{ "slidesToShow": 1, "slidesMargin":10}}]}'>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="{{asset('frontend/assets/images/home-03/brd-01.jpg')}}" width="214" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="{{asset('frontend/assets/images/home-03/brd-02.jpg')}}" width="214" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="{{asset('frontend/assets/images/home-03/brd-03.jpg')}}" width="153" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="{{asset('frontend/assets/images/home-03/brd-04.jpg')}}" width="224" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
            ...
            <ul class="biolife-carousel nav-center nav-none-on-mobile xs-margin-top-36px" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 2}},{"breakpoint":768, "settings":{ "slidesToShow": 2}},{"breakpoint":600, "settings":{ "slidesToShow": 1}}]}'>
                <li>
                    <div class="post-item effect-01 style-bottom-info layout-02 ">
                        <div class="thumbnail">
                            <a href="#" class="link-to-post"><img src="{{asset('frontend/assets/images/our-blog/news-1.jpg')}}" width="370" height="270" alt=""></a>
                            <div class="post-date">
                        ...
                        <div class="post-content">
                            ...
                            <div class="post-meta">
                                <a href="#" class="post-meta__item author"><img src="{{asset('frontend/assets/images/home-03/post-author.png')}}" width="28" height="28" alt=""><span>Admin</span></a>
                ...
                <li>
                    <div class="post-item effect-01 style-bottom-info layout-02">
                        <div class="thumbnail">
                            <a href="#" class="link-to-post"><img src="{{asset('frontend/assets/images/our-blog/news-2.jpg')}}" width="370" height="270" alt=""></a>
                            <div class="post-date">
                                <span class="date">26</span>
                                <span class="month">dec</span>
                            </div>
                ...
                <li>
                    <div class="post-item effect-01 style-bottom-info layout-02">
                        <div class="thumbnail">
                            <a href="#" class="link-to-post"><img src="{{asset('frontend/assets/images/our-blog/news-3.jpg')}}" width="370" height="270" alt=""></a>
                            <div class="post-date">
                                <span class="date">26</span>
                                <span class="month">dec</span>
                            </div>
