...
@section('content')
@section('title')
Offer Products | India's No 1 Online Saree Shop - Nithitex
@endsection
            ...
            <div class="col-lg-9">
                <div class="shop-topbar-wrapper">
                    <div class="shop-topbar-left">
                        ...
                        <p>Showing Nithi Tex's Offers </p>
                    </div>
                    ...
                    <div class="tab-content jump">
                        <div id="shop-1" class="tab-pane active">
                            <div class="row" id="grid_view_product">
                                @include('frontend.product.offers_grid_view')
                            </div>
                        </div>
                        <div id="shop-2" class="tab-pane" id="list_view_product">
                            @include('frontend.product.offers_list_view')
                        </div>
                    </div>
