            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-6">
                <div class="product-list-img">
                    <a href="{{url('product/details/'.$offers->id.'/'.$offers->product_slug ) }}">
                        <img src="{{ asset($offers->product_image)}}" alt="Product Style">
                    </a>
            ...
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-6">
                <div class="shop-list-content">
                    ...
                    <div class="product-list-action">
                        ...
                        <button title="Add To Cart" type="submit" id="{{ $offers->id }}" onclick="addToCartsimple(this.id)"><i class="icon-basket-loaded"></i></button>
                        <button title="Wishlist"><i class="icon-heart" id="{{ $offers->id }}" onclick="addToWishList(this.id)"></i></button>
                        <div>
                            <a href="{{url('product/buynow/'.$offers->id) }}" style="border-radius: 50px;" class="btn btn-danger buy mt-2">Buy Now </a>
                        </div>
                    </div>
                </div>
            </div>
