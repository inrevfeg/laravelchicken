                ...
                <div class="sumary-product single-layout">
                    <div class="media">
                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                            ...
                            <li><img src="{{ asset($mulimg->productMultiImage) }}" alt="" width="500" height="500"></li>
                            @endforeach
                        </ul>
                        <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                            @foreach($multiImage as $mulimg)
                            <li><img src="{{ asset($mulimg->productMultiImage) }}" alt="" width="88" height="88"></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="product-attribute">
                        ...
                        <p class="excerpt">{{ $product->productDescription }}</p>
                        <div class="price">
                    ...
                    <div class="action-form">
                        ...
                        <div class="buttons">
                            <a href="#" class="btn add-to-cart-btn" id="{{ $product->id }}" onclick="addToCartsimple(this.id)">add to cart</a>
                            <p class="pull-row">
                                <a href="#" class="btn wishlist-btn" id="{{ $product->id }}" onclick="addToWishList(this.id)">wishlist</a>
