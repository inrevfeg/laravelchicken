        ...
        <div class="container">
            <div class="top-bar left">
                <ul class="horizontal-menu">
                    <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>food@company.com</a></li>
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    <li class="horz-menu-item currency">
                        <a href="{{ route('track_order') }}">Track Your Order</a>
                    </li>
                    @auth
                    <li><a href="{{route('dashboard')}}" class="login-link">
                        <i class="biolife-icon icon-login"></i>User Profile
                    </a></li>
                    @else
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                    <a href="/" class="biolife-logo"><img src="{{asset('frontend/assets/images/organic-3.png')}}" alt="biolife logo" width="135" height="34"></a>
                </div>
                                            ...
                                            <ul class="posts">
                                                <li>
                                                    <div class="block-post-item">
                                                        <div class="thumb"><a href="#"><img src="{{asset('frontend/assets/images/megamenu/thumb-05.jpg')}}" width="100" height="73" alt=""></a></div>
                                                        <div class="left-info">
                                                ...
                                                <li>
                                                    <div class="block-post-item">
                                                        <div class="thumb"><a href="#"><img src="{{asset('frontend/assets/images/megamenu/thumb-06.jpg')}}" width="100" height="73" alt=""></a></div>
                                                        <div class="left-info">
                                                            <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                                ...
                                                <li>
                                                    <div class="block-post-item">
                                                        <div class="thumb"><a href="#"><img src="{{asset('frontend/assets/images/megamenu/thumb-07.jpg')}}" width="100" height="73" alt=""></a></div>
                                                        <div class="left-info">
                                                            <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                ...
                <div class="col-lg-3 col-md-3 col-md-6 col-xs-6">
                    <div class="biolife-cart-info">
                        ...
                        <div class="wishlist-block hidden-sm hidden-xs">
                            <a href="{{route('wishlist')}}" class="link-to">
                                <span class="icon-qty-combine">
                                    <i class="icon-heart-bold biolife-icon"></i>
                                    <span class="qty" id="wishlist_count"></span>
                                </span>
                            </a>
                        </div>
                            ...
                            <div class="minicart-contain">
                                <a href="javascript:void(0)" class="link-to">
                                        <span class="icon-qty-combine">
                                            ...
                                            <span class="qty" id="cartQty"></span>
                                        </span>
                                    <span class="title">My Cart ₹ </span>
                                    <span class="sub-total" id="cartSubTotal"></span>
                                </a>
                                <div class="cart-content">
                                    <div class="cart-inner">
                                        ...
                                        <p class="btn-control">
                                            <a href="{{route('mycart')}}" class="btn view-cart">view cart</a>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="vertical-menu vertical-category-block">
                        ...
                        <div class="wrap-menu">
                            <ul class="menu clone-main-menu">
                                @foreach ($categories as $item)
                                <li class="menu-item"><a href="{{ url('category/product/'.$item->id) }}" class="menu-title"><i class="biolife-icon icon-fast-food"></i>{{$item->categoryName}}</a></li>
                               @endforeach
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-9 col-md-8 padding-top-2px">
                    ...
                    <div class="live-info">
                        <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">9874561230</b></p>
